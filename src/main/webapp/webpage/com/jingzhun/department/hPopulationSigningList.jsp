...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hPopulationSigningList" checkbox="true" pagination="true" fitColumns="true" title="签约医生" actionUrl="hPopulationSigningController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
