...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hVolunteerList" checkbox="true" pagination="true" fitColumns="true" title="志愿者服务队" actionUrl="hVolunteerController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
