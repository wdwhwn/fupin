...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hTeamsHelpList" pageSize="15" checkbox="true" pagination="true" fitColumns="false" title="" actionUrl="hTeamsHelpController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
