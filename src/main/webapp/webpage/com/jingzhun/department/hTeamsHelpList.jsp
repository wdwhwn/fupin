...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hTeamsHelpList" checkbox="true" pagination="true" fitColumns="true" title="帮扶责任人" actionUrl="hTeamsHelpController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
