...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hPoorHouseholdList" checkbox="true" pagination="true" fitColumns="true" title="贫困户表" actionUrl="hPoorHouseholdController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
