...
<div class="easyui-layout" fit="true">
 <div region="center" style="padding:0px;border:0px">
  <t:datagrid name="poorHouseholdList1" pageSize="15"  pagination="false" fitColumns="true" title="" actionUrl="poorHouseholdController.do?datagridFamily&id=${requestScope.id}" idField="id1" sortName="id1" fit="false" queryMode="group">
  ...
  <t:datagrid name="poorHouseholdList"  pageSize="1"  pagination="false" fitColumns="true" title="" actionUrl="poorHouseholdController.do?datagridFamily&id=${requestScope.id}" idField="id" sortName="id" fit="false" queryMode="group">
   <t:dgCol title="主键自增"  field="id"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="行政县"  field="a1"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="乡镇"  field="a2"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="行政村"  field="a3"    queryMode="single"  width="120"></t:dgCol>
