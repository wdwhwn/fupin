...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:1px;overflow-x:hidden;">
       <%-- <div class="tab-opts-menu" id="tab-menus-main" style="font-size:14px">
            &lt;%&ndash;<div class="opts-menu-box">&ndash;%&gt;
                &lt;%&ndash;<div class="menus active table-menu-1" style="top:30px">&ndash;%&gt;
                    &lt;%&ndash;<!-- 主表菜单 -->&ndash;%&gt;
                    &lt;%&ndash;&lt;%&ndash;<t:menuButtons codes="addSingle,editSingle,batchDel,save,reject" name="jformOrderMain2" mm="true"></t:menuButtons>&ndash;%&gt;&ndash;%&gt;
                &lt;%&ndash;</div>&ndash;%&gt;
                &lt;%&ndash;&lt;%&ndash;<div class="menus table-menu-0" style="top:-1px">&ndash;%&gt;
                    &lt;%&ndash;<a title="重置" onclick="mainPageQueryReset()" href="####" class="btn-menu fa fa-refresh menu-more" ></a>&ndash;%&gt;
                    &lt;%&ndash;<a title="查询" onclick="associatedQuery('jformOrderMain2','jformOrderMain2List')" href="####" class="btn-menu fa fa-search menu-more"></a>&ndash;%&gt;
                &lt;%&ndash;</div>&ndash;%&gt;&ndash;%&gt;
            &lt;%&ndash;</div>&ndash;%&gt;
        </div>--%>

        <!-- 上方 -->
        <div  id="accDiv"  class="easyui-accordion" data-options="multiple:true" style="height:500px;padding-right:0px;overflow-x:hidden;box-sizing: border-box;">
            ...
            <div title="订单信息" data-options="iconCls:'icon-ok',selected:true"  >
                ...
                <div id="easyui_mainList1" class="resize-y-iframe" style="height:286px;padding-bottom:6px;">
