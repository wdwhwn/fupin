...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hPoorIncomeList" checkbox="true" pagination="true" fitColumns="true" title="财产收入" actionUrl="hPoorIncomeController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="hPoorIncomeController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="hPoorIncomeController.do?goAdd" funname="add"  width="800" height="500"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="hPoorIncomeController.do?goUpdate" funname="update"  width="800" height="500"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="hPoorIncomeController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="hPoorIncomeController.do?goUpdate" funname="detail"  width="800" height="500"></t:dgToolBar>
...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'hPoorIncomeController.do?upload', "hPoorIncomeList");
}

//导出
function ExportXls() {
	JeecgExcelExport("hPoorIncomeController.do?exportXls","hPoorIncomeList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("hPoorIncomeController.do?exportXlsByT","hPoorIncomeList");
}
