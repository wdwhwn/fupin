...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hPrimarySchoolList" checkbox="true" pagination="true" fitColumns="false" title="" actionUrl="hPrimarySchoolController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="类型"  field="type"  query="true"  queryMode="single"  dictionary="是否寄宿"  width="120"></t:dgCol>
   <t:dgCol title="发放月份"  field="month"  query="true"  queryMode="single"  dictionary="是否寄宿"  width="120"></t:dgCol>
   <t:dgCol title="发放金额"  field="money"  query="true"  queryMode="single"  dictionary="是否寄宿"  width="120"></t:dgCol>
