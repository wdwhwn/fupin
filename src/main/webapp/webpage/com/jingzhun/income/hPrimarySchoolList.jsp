...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hPrimarySchoolList" pageSize="15" checkbox="true" pagination="true" fitColumns="false" title="" actionUrl="hPrimarySchoolController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
