...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hLoanList" pageSize="15" checkbox="true" pagination="true" fitColumns="false" title="" actionUrl="hLoanController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="脱贫年度"  field="year"  queryMode="group"  width="120"></t:dgCol>
   ...
   <t:dgDelOpt title="删除" url="hLoanController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="hLoanController.do?goAdd" funname="add"  width="800" height="500"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="hLoanController.do?goUpdate" funname="update"  width="800" height="500"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="hLoanController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="hLoanController.do?goUpdate" funname="detail"  width="800" height="500"></t:dgToolBar>
...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'hLoanController.do?upload', "hLoanList");
}

//导出
function ExportXls() {
	JeecgExcelExport("hLoanController.do?exportXls","hLoanList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("hLoanController.do?exportXlsByT","hLoanList");
}
