...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hTeachingAgeSubsidyList" checkbox="true" pagination="true" fitColumns="true" title="原民办代课教师教龄补助" actionUrl="hTeachingAgeSubsidyController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
