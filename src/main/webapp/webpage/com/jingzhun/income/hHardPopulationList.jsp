...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hHardPopulationList" checkbox="true" pagination="true" fitColumns="false" title="" actionUrl="hHardPopulationController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
