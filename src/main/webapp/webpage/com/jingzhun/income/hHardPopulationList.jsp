...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hHardPopulationList" checkbox="true" pagination="true" fitColumns="true" title="农商行博华农业" actionUrl="hHardPopulationController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
