...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hVocationalSchoolList" pageSize="15" checkbox="true" pagination="true" fitColumns="true" title="中职教育补助金" actionUrl="hVocationalSchoolController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
