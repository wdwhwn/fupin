...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hHighSchoolList" pageSize="15" checkbox="true" pagination="true" fitColumns="true" title="高中教育补助金" actionUrl="hHighSchoolController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
