...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hFarmMachineryList" pageSize="15" checkbox="true" pagination="true" fitColumns="false" title="" actionUrl="hFarmMachineryController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
