...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hHardChildrenList" checkbox="true" pagination="true" fitColumns="false" title="" actionUrl="hHardChildrenController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
