...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="hHardOrphanController.do?doAdd" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="birthday" name="birthday" type="text" maxlength="30" class="form-control input-sm" placeholder="请输入出生日期"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="age" name="age" type="text" maxlength="10" class="form-control input-sm" placeholder="请输入年龄"  datatype="n"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="village" name="village" type="text" maxlength="100" class="form-control input-sm" placeholder="请输入行政村"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
