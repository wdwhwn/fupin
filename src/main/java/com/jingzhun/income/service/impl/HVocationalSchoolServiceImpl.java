...
@Service("hVocationalSchoolService")
@Transactional
public class HVocationalSchoolServiceImpl extends CommonServiceImpl implements HVocationalSchoolServiceI {
	...
	public List<Map<String, Object>> getVocationStudentList(Map<String, Object> conditionMap, DataGrid dataGrid) {
		...
		String sql="SELECT\n" +
				...
				"\tINNER JOIN h_vocational_school s ON e.IDNO = s.IDNO";
		logger.error(sql);
		if(dataGrid!=null){
