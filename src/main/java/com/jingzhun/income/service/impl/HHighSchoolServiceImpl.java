...
@Service("hHighSchoolService")
@Transactional
public class HHighSchoolServiceImpl extends CommonServiceImpl implements HHighSchoolServiceI {
	...
	public List<Map<String, Object>> getHighStudentList(Map<String, Object> conditionMap, DataGrid dataGrid) {
		...
		String sql="SELECT\n" +
				...
				"\tINNER JOIN h_high_school s ON e.IDNO = s.IDNO";
		logger.error(sql);
		if(dataGrid!=null){
