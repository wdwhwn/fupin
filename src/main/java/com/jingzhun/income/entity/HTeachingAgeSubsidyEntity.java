 ...
 */
@Entity
@Table(name = "h_teaching_age_subsidy", schema = "")
@SuppressWarnings("serial")
public class HTeachingAgeSubsidyEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 *@return: java.math.BigDecimal  补贴金额
	 */
	 ...
	 *@param: java.math.BigDecimal  补贴金额
	 */
