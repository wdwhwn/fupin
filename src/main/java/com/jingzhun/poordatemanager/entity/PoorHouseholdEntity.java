...
public class PoorHouseholdEntity implements java.io.Serializable {
	/**主键自增*/
	...
	/**脱贫年度*/
	@Excel(name="脱贫年度",width=15,dicCode="贫困户属性")
	...
	/**饮水安全*/
	@Excel(name="饮水安全",width=15)
	private java.lang.String a24;
	/**饮水困难*/
	@Excel(name="饮水困难",width=15)
